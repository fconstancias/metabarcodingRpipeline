...
option_list = list(
  ...
  make_option(c("--trunclen"), type="vector", default=c(260,250), 
  ...
  make_option(c("--trim_length"), type="vector", default = c(240,400), 
  ...
  make_option(c("--maxee"), type="vector", default = c(3,4), 
